  ...
  - table:
    ...
    - rowgroup:
      ...
      - row "Bob Williams Male Freshman Florida Physics Soccer":
        ...
        - cell "Physics"
        - cell "Soccer"
      - row "Daniel Martinez Secure data management for testing Seamless pagination for tables Male Freshman Nevada Political Science Football":
        - cell "Daniel Martinez Secure data management for testing Seamless pagination for tables":
          - text: Daniel Martinez
          - link "Secure data management for testing":
            - img
            - text: Secure data management for testing
