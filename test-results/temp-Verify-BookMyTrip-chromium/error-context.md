...
- img "credit-card"
- heading "Limited time offer - 0 Joining Fee" [level=2]
- text: VIEW BENEFITS
- list:
  - listitem: One Way
  - listitem: Round Trip
...
- combobox [expanded]:
  - textbox "From"
  - listbox:
    - paragraph: POPULAR CITIES
    - listbox:
      - option "Mumbai, India BOM Chhatrapati Shivaji International Airport":
        - paragraph: Mumbai, India
        - text: BOM
        - paragraph: Chhatrapati Shivaji International Airport
      - option "New Delhi, India DEL Indira Gandhi International Airport":
        - paragraph: New Delhi, India
        - text: DEL
        - paragraph: Indira Gandhi International Airport
      - option "Bangkok, Thailand BKK Bangkok":
        - paragraph: Bangkok, Thailand
        - text: BKK
        - paragraph: Bangkok
      - option "Bengaluru, India BLR Bengaluru International Airport":
        - paragraph: Bengaluru, India
        - text: BLR
        - paragraph: Bengaluru International Airport
      - option "Pune, India PNQ Pune Airport":
        - paragraph: Pune, India
        - text: PNQ
        - paragraph: Pune Airport
      - option "Hyderabad, India HYD Rajiv Gandhi International Airport":
        - paragraph: Hyderabad, India
        - text: HYD
        - paragraph: Rajiv Gandhi International Airport
      - option "Kolkata, India CCU Netaji Subhash Chandra Bose International Airport":
        - paragraph: Kolkata, India
        - text: CCU
        - paragraph: Netaji Subhash Chandra Bose International Airport
      - option "Chennai, India MAA Chennai International Airport":
        - paragraph: Chennai, India
        - text: MAA
        - paragraph: Chennai International Airport
      - option "Goa - Dabolim Airport, India GOI Goa Dabolim International Airport":
        - paragraph: Goa - Dabolim Airport, India
        - text: GOI
        - paragraph: Goa Dabolim International Airport
      - option "Dubai, United Arab Emirates DXB Dubai International":
        - paragraph: Dubai, United Arab Emirates
        - text: DXB
        - paragraph: Dubai International
- text: ⇌ To
- textbox "To BLR, Bengaluru International Airport India": Bengaluru
- paragraph: BLR, Bengaluru International Airport India
- text: Departure
- textbox "Departure 23 Aug'25 Saturday": Friday, 22 Aug 2025
- paragraph: 23 Aug'25
- paragraph: Saturday
- text: Return
...
- checkbox
- text: Add Flight Delay Protection Get compensation for delays of 1 hour or more View Details
- paragraph: Search
- main:
  - main:
    - text: Explore More
    ...
    - paragraph: Mega Price Drop on Holiday Packages for You.
    - paragraph: Book your 2nd – 5th October long weekend trip now.
    - text: Book Now
    - paragraph: INTL FLIGHTS T&C's Apply
    - paragraph: "LIVE NOW:"
    - paragraph: Up to 35% OFF* on your international trips.
    - text: Book Now
    - paragraph: INTL FLIGHTS T&C's Apply
    - paragraph: "FOR INTERNATIONAL FLIGHTS:"
    - paragraph: Grab Up to ₹15,000 OFF*
    - text: Book Now
    - paragraph: INTL FLIGHTS T&C's Apply
    - paragraph: "SAY YAY TO ALL TRAVEL PLANS WITH:"
    - paragraph: Up to 15% OFF* on flights & hotels.
    - text: View Details
    - paragraph: INTL FLIGHTS T&C's Apply
    - paragraph: "MAKE YOUR DREAM TRIP HAPPEN WITH:"
    - paragraph: Up to 15% OFF* on flights & hotels.
    - text: View Details
    - paragraph: RAILS T&C's Apply
    - paragraph: DIWALI WEEK TRAIN BOOKINGS OPEN
    - paragraph: Book by paying 25% of the fare* with our Seat Lock feature.
    - text: BOOK NOW
    - button "Next"
    ...
    - list: The Ascott Limited Kingston Hotels
    - button "Previous"
